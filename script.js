...
const url = CONFIG.API_BASE_URL; // Using config.js
...
function performSearch() {
    ...
    fetch(url + userInput)
        ...
        .then((data) => {
            ...
            const mealInstructions = escapeHtml(myMeal.strInstructions) || 'Instructions not available';
...
ScrollReveal().reveal('.mediaBoxes img, .Home_header', {
    origin: 'top',
});
